...
var marksCanvas = document.getElementById("bigChart1");
...
var ctx = document.getElementById('bigChart2').getContext('2d');
var mybigChart2 = new Chart(ctx, {
    type: 'horizontalBar',
    data: {
        labels: ['54-55', '45-54', '35-44', '21-87', '32-23', '90-21'],
        datasets: [{
...
var ctx = document.getElementById('bigChart3').getContext('2d');
var mybigChart3 = new Chart(ctx, {
    type: 'line',
    data: {
        labels: ['54-55', '45-54', '35-44', '21-87', '32-23', '90-21'],
        datasets: [{
